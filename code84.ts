var special = {
    ...
    36: { 0: 1/16, 5: 3/16, 10: 1/16, 11: 1/16, 12: 1/16, 24: 1/16, 33: 1/16, 36: 6/16, 39: 1/16 },// slightly off
};

var g_landingmap = function(pos : number){
   var obj = {};
   obj[pos] = 1;
   return special[pos] || obj;
}

var landingP = function (pos, prob) :any[]{
...
var rollingP = function(pos: number) {
  var probs = {};
  probs[10] = 1/64;
  var values = []
